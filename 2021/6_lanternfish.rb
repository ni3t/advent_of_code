...
# as a valid timer value). The new lanternfish starts with an internal timer of 8 and
...
# the ages of several hundred nearby lanternfish (your puzzle input). For example, suppose
