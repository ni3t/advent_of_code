...
# wire/segment connections are mixed up separately for each four-digit display! (All
...
T
#
# (The entry is wrapped here to two lines so it fits; in your notes, it will all be
# on a single line.)
#
...
# times appearing in all 10 digits
# f => 9 # unique
# b => 6 # unique
# e => 4 # unique
# d => 7 # found
