...
# (according to the corrupted database) and the corporate policy when that password
# was set.
#
...
# to be valid. For example, 1-3 a means that the password must contain a at least 1
...
# the given letter. Other occurrences of the letter are irrelevant for the purposes
