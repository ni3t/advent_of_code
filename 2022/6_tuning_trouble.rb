...
# He says that it has many fancy features, but the most important one to set up right
# now is the communication system.
#
...
# The signal is a series of seemingly-random characters that the device receives one
# at a time.
#
